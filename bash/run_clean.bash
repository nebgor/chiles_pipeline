...
# Copy files from S3
#python2.7 /home/centos/chiles_pipeline/python/launch_trace2.py python2.7 /home/centos/chiles_pipeline/python/copy_clean_input.py {0} -p 4
python2.7 /home/centos/chiles_pipeline/python/copy_clean_input.py {0} -p 4

# Log the disk usage
df -h

# Run the clean pipeline
#python2.7 /home/centos/chiles_pipeline/python/launch_trace2.py bash -vx /home/centos/chiles_pipeline/bash/start_clean.sh {1} {2}
bash -vx /home/centos/chiles_pipeline/bash/start_clean.sh {1} {2}

# Log the disk usage
df -h

# Copy files to S3
python2.7 /home/centos/chiles_pipeline/python/copy_clean_output.py {0}

# Copy files to S3
python2.7 /home/centos/chiles_pipeline/python/copy_log_files.py -p 3 CLEAN-log/{0}
