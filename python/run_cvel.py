...
from common import make_safe_filename, get_cloud_init, setup_boto_and_git, get_script, Consumer, LOGGER
...
class Task(object):
    ...
    def __call__(self):
        ...
        setup_boto_and_git(ec2_instance.ip_address, self._aws_access_key_id, self._aws_secret_access_key)
...
def start_servers(processes, ami_id, user_data, instance_type, observation_id, snapshot_ids, created_by, name, spot_price=None, aws_access_key_id=None, aws_secret_access_key=None, zone=None):
    ...
    for snapshot_id in snapshot_ids:
        tasks.put(Task(ami_id, user_data, instance_type, observation_id, snapshot_id, created_by, name, spot_price, aws_access_key_id, aws_secret_access_key, zone))
